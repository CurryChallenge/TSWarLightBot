...
'use strict';
describe('goCommand', function () {
    // Class for unit under test and variable for instance of unit under test.
    var GoCommand = require('../../../TSWarLightBotEmpty/command/GoCommand');
    var goCommand;
    // Mocks and spies.
    ...
    describe('getAnswer', function () {
        it('Should call place_armies method on goCommand if ICommandData.option is place_armies.', function () {
            // arange
            // act
            // assert
        });
        it('Should call attacktransfer method on goCommand if ICommandData.option is attacktransfer.', function () {
            // arange
            // act
            // assert
        });
        // error string should be filled too.
        it('Should return Answer.succes = false in Answer.value if ICommandData.option not matches any option in goCommand.', function () {
            // arange
            // act
            // assert
        });
    ...
    describe('place_armies', function () {
        // Should call getOwnedRegions only once and with PossibleOwnersEnum.PLAYER.
        it('Should call getOwnedRegions on warMap', function () {
            // arange
            // act
            // assert
        });
        // settings gets injected and holds OptionEnum.starting_armies.
        it('Should call Math.random for the amount of armies it has to place OptionEnum.starting_armies', function () {
            // arange
            // act
            // assert
        });
        // regions are part of the warmap which gets injected in the goCommand instance.
        it('Should add +1 on troopCount the region found by index of Math.random.', function () {
            // arange
            // act
            // assert
        });
        ...
        it('Should return a placement for every army.', function () {
            // arange
            // act
            // assert
        });
    ...
    describe('attacktransfer', function () {
        ...
        it('Should call getRegionsToAttackTransfer on goCommand twice', function () {
            // arange
            // act
            // assert
        });
        ...
        it('Should set troopsCount to 1 on regionFrom result from getRegionsToAttackTransfer with argument own=false', function () {
            // arange
            // act
            // assert
        });
        ...
        // regionFrom is part of the IMove instance returned by getRegionsToAttackTransfer.
        it('Should set troopsCount to 1 on regionFrom from getRegionsToAttackTransfer result for an attack', function () {
            // arange
            // act
            // assert
        });
        ...
        it('Should return a move for every IMoveData.', function () {
            // arange
            // act
            // assert
        });
        ...
        it('should not return moves if no regions are returned by getRegionsToAttackTransfer', function () {
            // arange
            // act
            // assert
        });
    });
    describe('getRegionsToAttackTransfer', function () {
        ...
        it('Should return correct regions for attack.', function () {
            // arange
            // act
            // assert
        });
        ...
        // regions[index] in which index is determind with Math.random.
        it('Should return correct regions for transfer.', function () {
            // arange
            // act
            // assert
        });
...
//# sourceMappingURL=GoCommandSpec.js.map