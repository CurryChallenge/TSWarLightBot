...
(function (CommandEnum) {
     ...
     */
    CommandEnum[CommandEnum["setup_map"] = 0] = "setup_map";
    /*
     ...
     */
    CommandEnum[CommandEnum["pick_starting_regions"] = 1] = "pick_starting_regions";
    /*
     ...
     */
    CommandEnum[CommandEnum["settings"] = 2] = "settings";
    /*
     ...
     */
    CommandEnum[CommandEnum["update_map"] = 3] = "update_map";
    /*
     * All the visible moves the opponent has done are given in consecutive order.
     */
    CommandEnum[CommandEnum["opponent_moves"] = 4] = "opponent_moves";
    /*
     ...
     */
    CommandEnum[CommandEnum["go"] = 5] = "go";
